...
const UserProfile = ({ navigation,route }) => {
  ...
  return (
      <>
    <TempHeader title={title} navigation={navigation}/>

    <View>
   <UserProfileCard cardImageLink={profileImage} nameDescription={nameDescription} nameMeaning={nameMeaning} videoLink={videoLink} audioLink={audioLink}/> 
  </View>
  </>
  );
};
